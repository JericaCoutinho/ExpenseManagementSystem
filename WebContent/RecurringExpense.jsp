...
<body>
	<div class="sidebar" data-background-color="white"
		...
		<div class="sidebar-wrapper">
			...
			<ul class="nav">
				...
				<li class="active"><a href="RecurringExpense.jsp"> 
				<i class="ti-view-list-alt"></i>
						<p><font size="2" color= "black">Recurring Expenses</font></p>
				</a></li>
				
				<li><a href="Finance_Advisor.jsp"> 
	...
	<div class="main-panel">
					...
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							data-toggle="dropdown"> <i class="ti-bell"></i>
								...
								<p><font size="2" color= "black"><b>Notifications</b></font></p> <b class="caret"></b>
						</a>
						...
						<li><a href="logout.jsp"> <i class="ti-settings"></i>
								<p><font size="2" color= "black"><b>Logout</b></font></p>
						</a></li>
					</ul>
				</div>
			</div>
		...
		<div class="form-style-8">
			<h2><font color="white">Recurring Expense</font></h2>
			<form>
				<b><font size="5" color= "black">Username:</b> </font><input class="effect-1" type="text" name="username"
					disabled id="username"
					value="<%=session.getAttribute("username")%>" /> <b><font size="5" color= "black">Expense
					...
					</select> <b><font size="5" color= "black">Expense Date: </b></font><input type="text" name="date"
						id="datepicker" placeholder="Expense Date"> <b><font size="5" color= "black">Expense
							Value :</b></font><input type="text" name="value" id="value"
						placeholder="Expense Value"> <b><font size="5" color= "black">Billing Frequency:</b></font><select
						id="frequency">
							<option value="yearly">Yearly</option>
							<option value="monthly">Monthly</option>
							<option value="weekly">Weekly</option>
					</select> <input type="button" value="Add" onclick="myfunction()" />
