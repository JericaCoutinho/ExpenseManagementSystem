          ...
          <ul class="nav">
            <li><a href="advisorHome.jsp"> <i class="ti-panel"></i>
                ...
                <li>
                    <a href="table.jsp">
                        <i class="ti-email"></i>
                        <p><font size="2" color="black">Messages</p>
                    </a>
                </li>
                <li class="active"><a href="Financier_Customer_List.jsp"> 
                <i class="ti-pencil-alt2"></i>
						<p><font size="2" color="black">List of Customers</p>
				</a></li>
			...
			<div class="card">
				...
				<h5 class="mb-0">
					<button class="btn btn-link" data-toggle="collapse"
						...
						aria-controls="collapseOne"><%=(session.getAttribute("customerFirstName") + " " + session.getAttribute("customerLastName"))%></button>
				</h5>
			</div>
				...
				<div id="collapseOne" class="collapse"
					...
					<div class="card-body">
						<ul class="list-group">
							<li class="list-group-item"><%=session.getAttribute("customerFirstName") + " " + session.getAttribute("customerLastName")%></li>
							<li class="list-group-item"><%=session.getAttribute("customerEmail")%></li>
						</ul>
					</div>
				</div>
			</div>
