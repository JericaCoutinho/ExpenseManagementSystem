...
<div class="form-style-8">
  ...
  <form>
	...
	<b>Expense Description:<b><input type="text" name="description" id="description" placeholder="Eg. Netflix, Prime or Blue Apron"/>				
   <b>Expense Category:</b> <select id="category">
    ...
    <b>Billing Frequency:</b><select id="frequency">
	...
	<div  style="position:absolute; left:100px;height:100px; width:75%;" id="Response"></div>
