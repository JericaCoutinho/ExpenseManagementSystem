	...
	-->
			...
			<div class="sidebar-wrapper">
				...
				<ul class="nav">
					...
					<li class="active"><a href="table.jsp"> <i class="ti-email"></i>
			...
			<nav class="navbar navbar-default">
				<div class="container-fluid">
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="#"><font size="5" color="black">Messages</font></a>
					</div>
								...
								<div class="content">
									...
									<div class="footer">
										...
										<div class="stats">
											...
											<button
												onclick="startchating('<%=financierName%>','<%=customer.getusername()%>')">Chat</button>
